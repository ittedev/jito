...
export function mount(selectors: string, html: string, data: StateStack): void
...
export function mount(selectors: string, template: TreeTemplate, data: StateStack): void
...
export function mount(selectors: string, patcher: Patcher, data: StateStack): void
...
export function mount(element: Element, html: string, data: StateStack): void
...
export function mount(element: Element, template: TreeTemplate, data: StateStack): void
...
export function mount(element: Element, patcher: Patcher, data: StateStack): void
...
export function mount(target: string | Element, template: string | TreeTemplate | Patcher | Component, data: StateStack | Record<string, unknown> | Main): void
