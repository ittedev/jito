...
```shell
deno install -f --allow-read --allow-write --allow-env --allow-run --allow-net https://deno.land/x/beako@v0.9.21/cli/beako.ts
```

```ts
import { watch, hack } from 'https://deno.land/x/beako@0.9.21/mod.ts'
...
<body>Loading...</body>
<script type="module">
  import { watch, hack } from 'https://cdn.jsdelivr.net/gh/ittedev/beako@0.9.21/beako.js'
