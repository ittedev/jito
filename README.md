...
<body></body>
<script type="module">
  import { watch, mount } from 'https://cdn.jsdelivr.net/gh/ittedev/jito@1.4.2/jito.js'
...
```js
<script type="module">
  import { ... } from 'https://cdn.jsdelivr.net/gh/ittedev/jito@1.4.2/jito.js'
  ...
</script>
```
...
```ts
import { ... } from 'https://deno.land/x/jito@1.4.2/mod.ts'
```
